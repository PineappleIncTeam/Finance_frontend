                ...
                <div className={style.calculationWrapper}>
                    <form className={style.calculatorFormContentWrapper}>
                        ...
                        <div className={style.propertyValueContainer}>
                            <label className={style.propertyValueContainer__label} htmlFor="propertyValue">Стоимость недвижимости, ₽</label>
                        ...
                        <div className={style.propertyValueContainer}>
                            <label className={style.propertyValueContainer__label} htmlFor="initialContribution">Первоначальный взнос, ₽</label>
                            <div className={style.inputRangeFieldContainer}>
                                <input
                                    type="text"
                                    value={formatNumber(value)}
							...
							<div className={style.propertyButtonRadioContainer}>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__5" className={style.propertyButtonRadioContainer__input} />
								...
								<input name="percent" type="radio" id="propertyButtonRadioContainer__10" className={style.propertyButtonRadioContainer__input} />
								...
								<input name="percent" type="radio" id="propertyButtonRadioContainer__15" className={style.propertyButtonRadioContainer__input} />
								...
								<input name="percent" type="radio" id="propertyButtonRadioContainer__20" className={style.propertyButtonRadioContainer__input} />
								...
								<input name="percent" type="radio" id="propertyButtonRadioContainer__25" className={style.propertyButtonRadioContainer__input} />
								...
								<input name="percent" type="radio" id="propertyButtonRadioContainer__30" className={style.propertyButtonRadioContainer__input} />
                        ...
                        <div className={style.propertyValueContainer}>
							...
							<div className={style.propertyButtonRadioContainer}>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__5year" className={style.propertyButtonRadioContainer__input} />
								<label htmlFor="propertyButtonRadioContainer__5year" className={style.propertyButtonRadioContainer__label}>
									<p className={style.propertyButtonRadioContainer__text}>5 лет</p>
								</label>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__10year" className={style.propertyButtonRadioContainer__input} />
								<label htmlFor="propertyButtonRadioContainer__10year" className={style.propertyButtonRadioContainer__label}>
									<p className={style.propertyButtonRadioContainer__text}>10 лет</p>
								</label>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__15year" className={style.propertyButtonRadioContainer__input} />
								<label htmlFor="propertyButtonRadioContainer__15year" className={style.propertyButtonRadioContainer__label}>
									<p className={style.propertyButtonRadioContainer__text}>15 лет</p>
								</label>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__20year" className={style.propertyButtonRadioContainer__input} />
								<label htmlFor="propertyButtonRadioContainer__20year" className={style.propertyButtonRadioContainer__label}>
									<p className={style.propertyButtonRadioContainer__text}>20 лет</p>
								</label>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__25year" className={style.propertyButtonRadioContainer__input} />
								<label htmlFor="propertyButtonRadioContainer__25year" className={style.propertyButtonRadioContainer__label}>
                        ...
                        <div className={style.propertyValueContainer}>
							...
							<div className={style.propertyButtonRadioContainer}>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__5-5" className={style.propertyButtonRadioContainer__input} />
								<label htmlFor="propertyButtonRadioContainer__5-5" className={style.propertyButtonRadioContainer__label}>
									<p className={style.propertyButtonRadioContainer__text}>5.5%</p>
								</label>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__7-5" className={style.propertyButtonRadioContainer__input} />
								<label htmlFor="propertyButtonRadioContainer__7-5" className={style.propertyButtonRadioContainer__label}>
									<p className={style.propertyButtonRadioContainer__text}>7.5%</p>
								</label>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__7-9" className={style.propertyButtonRadioContainer__input} />
								<label htmlFor="propertyButtonRadioContainer__7-9" className={style.propertyButtonRadioContainer__label}>
									<p className={style.propertyButtonRadioContainer__text}>7.9%</p>
								</label>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__11-4" className={style.propertyButtonRadioContainer__input} />
								<label htmlFor="propertyButtonRadioContainer__11-4" className={style.propertyButtonRadioContainer__label}>
									<p className={style.propertyButtonRadioContainer__text}>11.4%</p>
								</label>
								<input name="percent" type="radio" id="propertyButtonRadioContainer__13-5" className={style.propertyButtonRadioContainer__input} />
								<label htmlFor="propertyButtonRadioContainer__13-5" className={style.propertyButtonRadioContainer__label}>
