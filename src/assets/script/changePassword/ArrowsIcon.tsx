  ...
  export const ArrowsIcon = ({classNames}: IIconsProps) => {
    return (
       <svg className={classNames} width="36" height="49" viewBox="0 0 36 49" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M3.77175 25.0396L18.273 20.595L31.2894 28.3804" stroke="#DCDDDD" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        <path d="M1.49441 43.7969L15.9956 39.3523L29.012 47.1378" stroke="#DCDDDD" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
    )
  }
