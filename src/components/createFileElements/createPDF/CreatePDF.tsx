...
const CreatePDF = ({ allOperationList, dataCalRange }: any) => {
	...
	return (
		<div style={styles.page}>
			...
			{incomeCash && incomeCash.length > 0 && <h3 style={styles.introText}>Операции с доходами</h3>}
			{incomeCash &&
			...
			{outcomeCash && outcomeCash.length > 0 && <h3 style={styles.introText}>Операции с расходами</h3>}
			{outcomeCash &&
			...
			{moneyBox && moneyBox.length > 0 && <h3 style={styles.introText}>Операции с накоплениями</h3>}
			{moneyBox &&
